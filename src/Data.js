export const moviesData = [
    ...
    {
        id: 4,
        title: "Easter Someday ",
        rate: 1,
        description:
            "Own It March 02, 2021 Ava, a young girl, is tired of her parents demanding excellence from her, so she wishes to be someplace else and finds herself in an alternate universe called �Someday�",
        posterUrl:
        "https://th.bing.com/th?id=AMMS_ddf3993a78bfef9f2e75a19eb40f1450&w=200&h=150&c=8&rs=1&o=6&pid=5.1",
        trailer:"https://www.youtube.com/watch?v=1i7XcQC_tm4&list=PLDySQNnzfMCqoBxquMEhCOi0GUEB1RbCf&index=34",
    },
    {
        id: 5,
